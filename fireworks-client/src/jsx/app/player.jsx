define(['jquery', 'React', 'app/log', 'app/prefs'], function ($, React, Log, Prefs) {
    ...
    var Player = React.createClass({
        ...
        animateHint(hintInfo) {
            ...
            }, 5000 * this.state.animationCoeff);
        },
        animatePlay(gameEvent) {
            ...
            manager.preloadResource(manager.getCardRes(cardPlayed), () => {
                ...
                if (!gameEvent.playable) {
                    ...
                    TweenMax.to($noSign, 0.3 * this.state.animationCoeff, {delay: 0.3, yoyo:true, repeat:4, autoAlpha: 1, onComplete: () => {
            ...
            manager.preloadResource(manager.getCardRes(cardDisc), () => {
                setTimeout(() => {
                    ...
                    TweenLite.to($card, 0.3, {x: finalX, y: finalY, scale: finalScale, 
                        delay: 2.3 * this.state.animationCoeff, autoAlpha: 0, onComplete: () => {
